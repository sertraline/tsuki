...
RUN apt update
RUN apt install -y postgresql redis python3-pip python3-venv ffmpeg libsm6 libxext6 whois
...
CMD ["bash", "-c", "service redis-server start && service postgresql start && python3 main.py"]